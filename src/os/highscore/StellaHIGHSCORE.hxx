...
#ifndef STELLA_HIGHSCORE_HXX
#define STELLA_HIGHSCORE_HXX
...
/**
  This class wraps Stella core for easier highscore maintenance
*/
class StellaHIGHSCORE
{
  public:
    StellaHIGHSCORE();

  public:
    OSystemHIGHSCORE& osystem() const { return *myOSystem; }
  ...
  private:
    ...
    StellaHIGHSCORE(const StellaHIGHSCORE&) = delete;
    StellaHIGHSCORE(StellaHIGHSCORE&&) = delete;
    StellaHIGHSCORE& operator=(const StellaHIGHSCORE&) = delete;
    StellaHIGHSCORE& operator=(StellaHIGHSCORE&&) = delete;

    unique_ptr<OSystemHIGHSCORE> myOSystem;
