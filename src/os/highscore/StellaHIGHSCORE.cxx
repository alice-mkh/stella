...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
bool StellaHIGHSCORE::create(bool logging)
{
  system_ready = false;
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void StellaHIGHSCORE::updateInput()
{
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void StellaHIGHSCORE::updateVideo()
{
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void StellaHIGHSCORE::updateAudio()
{
  static_cast<SoundHIGHSCORE&>(myOSystem->sound()).dequeue(audio_buffer.get(), &audio_samples);
}

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
bool StellaHIGHSCORE::loadState(const void* data, size_t size)
{
  Serializer state;
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
bool StellaHIGHSCORE::saveState(void* data, size_t size) const
{
  Serializer state;
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
size_t StellaHIGHSCORE::getStateSize() const
{
  Serializer state;
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
float StellaHIGHSCORE::getVideoAspectPar() const
{
  float par;
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
float StellaHIGHSCORE::getVideoAspect() const
{
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void* StellaHIGHSCORE::getVideoBuffer() const
{
  if (!render_surface)
  {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
bool StellaHIGHSCORE::getVideoNTSC() const
{
  return myOSystem->console().gameRefreshRate() == 60;
}

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
bool StellaHIGHSCORE::getVideoResize()
{
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void StellaHIGHSCORE::setROM(const char* path, const void* data, size_t size)
{
  rom_path = path;
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void StellaHIGHSCORE::setConsoleFormat(uInt32 mode)
{
  switch(mode)
  {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void StellaHIGHSCORE::setVideoFilter(NTSCFilter::Preset mode)
{
  video_filter = mode;
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void StellaHIGHSCORE::setVideoPhosphor(uInt32 mode, uInt32 blend)
{
  switch (mode)
  {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void StellaHIGHSCORE::setAudioStereo(int mode)
{
  switch (mode)
  {
