...
#ifndef FS_NODE_HIGHSCORE_HXX
#define FS_NODE_HIGHSCORE_HXX

#include "FSNode.hxx"

/*
 * Implementation of the Stella file system API based on HIGHSCORE API.
 *
 * Parts of this class are documented in the base interface class,
 * AbstractFSNode.
 */
class FSNodeHIGHSCORE : public AbstractFSNode
{
  public:
    FSNodeHIGHSCORE();

    explicit FSNodeHIGHSCORE(string_view path);
