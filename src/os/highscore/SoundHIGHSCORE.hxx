...
#ifndef SOUND_HIGHSCORE_HXX
#define SOUND_HIGHSCORE_HXX
...
/**
  This class implements the sound API for HIGHSCORE.

  @author Stephen Anthony and Christian Speckner (DirtyHairy)
*/
class SoundHIGHSCORE : public Sound
{
  public:
    /**
      ...
      using the object.
    */
    SoundHIGHSCORE(OSystem& osystem, AudioSettings& audioSettings)
      : Sound(osystem),
        myAudioSettings{audioSettings}
    {
      Logger::debug("SoundHIGHSCORE::SoundHIGHSCORE started ...");
      Logger::debug("SoundHIGHSCORE::SoundHIGHSCORE initialized");
    }
    ~SoundHIGHSCORE() override = default;
  ...
  private:
    ...
    SoundHIGHSCORE() = delete;
    SoundHIGHSCORE(const SoundHIGHSCORE&) = delete;
    SoundHIGHSCORE(SoundHIGHSCORE&&) = delete;
    SoundHIGHSCORE& operator=(const SoundHIGHSCORE&) = delete;
