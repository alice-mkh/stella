...
#ifndef FBSURFACE_HIGHSCORE_HXX
#define FBSURFACE_HIGHSCORE_HXX

#include "bspf.hxx"
#include "FBSurface.hxx"

/**
  An FBSurface suitable for the HIGHSCORE API.  As with FBBackend,
  most of the functionality here is handled by highscore directly.

  @author  Stephen Anthony
*/
class FBSurfaceHIGHSCORE : public FBSurface
{
  public:
  ...
  private:
    ...
    FBSurfaceHIGHSCORE() = delete;
    FBSurfaceHIGHSCORE(const FBSurfaceHIGHSCORE&) = delete;
    FBSurfaceHIGHSCORE(FBSurfaceHIGHSCORE&&) = delete;
    FBSurfaceHIGHSCORE& operator=(const FBSurfaceHIGHSCORE&) = delete;
