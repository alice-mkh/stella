...
#ifndef OSYSTEM_HIGHSCORE_HXX
#define OSYSTEM_HIGHSCORE_HXX
...
/**
  This class defines an OSystem object for highscore.
...
*/
class OSystemHIGHSCORE : public OSystem
{
  public:
    OSystemHIGHSCORE() = default;
    ~OSystemHIGHSCORE() override = default;
